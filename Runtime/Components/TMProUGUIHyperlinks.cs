...
namespace BioluminescentGames.Utils.Components
{
    ...
    public class TMProUGUIHyperlinks : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
        ...
        private void LateUpdate()
        {
            ...
            {
                if (linkIndex !=
                    hoveredLinkIndex) // We started hovering above link (hover can be set from OnPointerDown!)
                {
        ...
        private List<Color32[]> SetLinkColor(int linkIndex, Color32 color)
        {
            ...
            for (int i = 0; i < linkInfo.linkTextLength; i++)
            {
                ...
                int meshIndex =
                    charInfo
                        .materialReferenceIndex; // Get the index of the material/subtext object used by this character.
                ...
                oldVertexColors.Add(new Color32[]
                {
                ...
                if (charInfo.isVisible && charInfo.underlineVertexIndex > 0 &&
                    charInfo.underlineVertexIndex != underlineIndex &&
                    charInfo.underlineVertexIndex < vertexColors.Length)
                {
